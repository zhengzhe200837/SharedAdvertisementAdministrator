...
import com.wind.main.adapter.DayAdapter;
import com.wind.main.mode.DateItem;
import com.wind.main.util.DateUtil;
...
public class ZzHorizontalCalenderView extends FrameLayout {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        Log.d("zz", "ZzHorizontalCalenderView + height = " + getHeight());
        Log.d("zz", "ZzHorizontalCalenderView + width = " + getWidth());
        Log.d("zz", "rootView + height = " + rootView.getHeight());
        Log.d("zz", "rootView + width = " + rootView.getWidth());
        Log.d("zz", "rv + height = " + rv.getHeight());
        Log.d("zz", "rv + width = " + rv.getWidth());
    }
